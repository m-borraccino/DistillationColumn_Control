...
%F:   ode15s Solve stiff differential equations and DAEs, variable order method.
...
% grid on
% sigma(G82,'r-')
% title('Singular Value Plot of G and G_4 ')
% legend('Singular Value of G','Singular Value of G4') 
